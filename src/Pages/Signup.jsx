            ...
            <div className="grid grid-cols-1 md:grid-cols-2 sm:grid-cols-1 ">
                <div className=" mt-5  mr-3 ml-3  sm:mr-10 sm:ml-10 md:mr-20 md:ml-20"> {/*The writing side */}
                   <div className="flex justify-between">
                    ...
                    <a href="http://localhost:5173/search" className=" flex items-center" ><span class="ml-2 text-xl">&#8592;</span> Back to campground</a>
                    </div> 
                    ...
                    <input className=" bg-slate-50 pr-32 sm:pr-48 md:pr-48 pt-2 pb-2" type="text" placeholder="Choose password" />
                    <div className=" pt-5"><Link to='/Signin' ><button className=" bg-black text-white pl-32 pr-32  sm:pl-48 sm:pr-32 md:pl-32 md:pr-32 pt-2 pb-2">Create an account</button></Link></div>
                    <div className=" flex pt-2 md:pb-32 pb-3">
                        <p>Already a user?</p>
                        <a href="http://localhost:5173/Signin" className=" text-blue-400 underline">Sign in</a>
                    </div>
                </div>
