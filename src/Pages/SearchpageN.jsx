...
const SearchpageN = () =>{
  ...
  <div className=" mr-5 ml-5 md:mr-20 md:ml-20">
    ...
    <div className=" bg-amber-50 pl-10 pt-10 pb-10">
      ...
      <a href="https://main--yelpcampcodewithomali.netlify.app/Signin" className=" underline">Or add your own campground</a>
      </div>
      <div className=" pt-16">
        <div  className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <Link to ='/individualpage' > <button className=" border font-bold pr-16 pl-16 pt-3 pb-3 items-center mt-3  "> View Campground</button></Link>
          </div>
          <div  className=" border pt-4 pb-4 pl-4 pr-4 ">
            {/* Calaguas Island*/}
